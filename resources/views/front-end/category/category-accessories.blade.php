				...
				<div class="col-md-8 w3ls_mobiles_grid_right">
					<div class="col-md-6 w3ls_mobiles_grid_right_left">
						<div class="w3ls_mobiles_grid_right_grid1">
							<img src="{{asset('/')}}/front-end/images/48.jpg" alt=" " class="img-responsive" />
					...
					<div class="col-md-6 w3ls_mobiles_grid_right_left">
						<div class="w3ls_mobiles_grid_right_grid1">
							<img src="{{asset('/')}}/front-end/images/49.jpg" alt=" " class="img-responsive" />
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								<div class="hs-wrapper hs-wrapper2"> 
									<img src="{{asset('/')}}/front-end/images/p8.jpg" alt=" " class="img-responsive" />
									<img src="{{asset('/')}}/front-end/images/p9.jpg" alt=" " class="img-responsive" />
									<img src="{{asset('/')}}/front-end/images/p10.jpg" alt=" " class="img-responsive" />
									<img src="{{asset('/')}}/front-end/images/p9.jpg" alt=" " class="img-responsive" />
									<img src="{{asset('/')}}/front-end/images/p8.jpg" alt=" " class="img-responsive" /> 
									<div class="w3_hs_bottom w3_hs_bottom_sub1">
										<ul>
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								<div class="hs-wrapper hs-wrapper2">
									<img src="{{asset('/')}}/front-end/images/p6.jpg" alt=" " class="img-responsive" />
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="agile_ecommerce_tab_left mobiles_grid">
								<div class="hs-wrapper hs-wrapper2">
									<img src="{{asset('/')}}/front-end/images/p7.jpg" alt=" " class="img-responsive" />
									<img src="{{asset('/')}}/front-end/images/p11.jpg" alt=" " class="img-responsive" />
									<img src="{{asset('/')}}/front-end/images/p3.jpg" alt=" " class="img-responsive" />
									<img src="{{asset('/')}}/front-end/images/p11.jpg" alt=" " class="img-responsive" />
									<img src="{{asset('/')}}/front-end/images/p7.jpg" alt=" " class="img-responsive" /> 
									<div class="w3_hs_bottom w3_hs_bottom_sub1">
										<ul>
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							<div class="hs-wrapper hs-wrapper3">
								<img src="{{asset('/')}}/front-end/images/p3.jpg" alt=" " class="img-responsive" />
								<img src="{{asset('/')}}/front-end/images/p5.jpg" alt=" " class="img-responsive" />
								<img src="{{asset('/')}}/front-end/images/p4.jpg" alt=" " class="img-responsive" />
								<img src="{{asset('/')}}/front-end/images/p2.jpg" alt=" " class="img-responsive" />
								<img src="{{asset('/')}}/front-end/images/p1.jpg" alt=" " class="img-responsive" /> 
								<div class="w3_hs_bottom">
									<div class="flex_ecommerce">
