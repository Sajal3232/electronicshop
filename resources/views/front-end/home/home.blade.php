		...
		<div class="container">
			<div class="col-md-5 wthree_banner_bottom_left">
				<div class="video-img">
					...
					<!-- pop-up-box -->     
					<script src="{{asset('/')}}/front-end/js/jquery.magnific-popup.js" type="text/javascript"></script>
					<!--//pop-up-box -->
					...
					<div id="myTabContent" class="tab-content">
							...
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									<div class="hs-wrapper">
										<img src="{{asset('/')}}/front-end/images/3.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/4.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/5.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/6.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/7.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/3.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/4.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/5.jpg" alt=" " class="img-responsive" />
						...
						<div role="tabpanel" class="tab-pane fade" id="audio" aria-labelledby="audio-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									<div class="hs-wrapper">
										<img src="{{asset('/')}}/front-end/images/8.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/9.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/10.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/8.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/9.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/10.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/8.jpg" alt=" " class="img-responsive" />
						...
						<div role="tabpanel" class="tab-pane fade" id="video" aria-labelledby="video-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									<div class="hs-wrapper">
										<img src="{{asset('/')}}/front-end/images/11.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/12.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/13.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/11.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/12.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/13.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/11.jpg" alt=" " class="img-responsive" />
						...
						<div role="tabpanel" class="tab-pane fade" id="tv" aria-labelledby="tv-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									<div class="hs-wrapper">
										<img src="{{asset('/')}}/front-end/images/14.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/15.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/16.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/14.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/15.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/16.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/14.jpg" alt=" " class="img-responsive" />
						...
						<div role="tabpanel" class="tab-pane fade" id="kitchen" aria-labelledby="kitchen-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									<div class="hs-wrapper">
										<img src="{{asset('/')}}/front-end/images/17.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/18.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/19.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/17.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/18.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/19.jpg" alt=" " class="img-responsive" />
										<img src="{{asset('/')}}/front-end/images/17.jpg" alt=" " class="img-responsive" />
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<section>
					<div class="modal-body">
						<div class="col-md-5 modal_body_left">
							<img src="{{asset('/')}}/front-end/images/36.jpg" alt=" " class="img-responsive" />
						</div>
						<div class="col-md-7 modal_body_right">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<section>
					<div class="modal-body">
						<div class="col-md-5 modal_body_left">
							<img src="{{asset('/')}}/front-end/images/37.jpg" alt=" " class="img-responsive" />
						</div>
						<div class="col-md-7 modal_body_right">
			...
			<div class="w3agile_special_deals_grids">
				<div class="col-md-7 w3agile_special_deals_grid_left">
					<div class="w3agile_special_deals_grid_left_grid">
						<img src="{{asset('/')}}/front-end/images/21.jpg" alt=" " class="img-responsive" />
					...
					<div class="wmuSlider example1">
						<div class="wmuSliderWrapper">
							...
							<article style="position: absolute; width: 100%; opacity: 0;"> 
								<div class="banner-wrap">
									<div class="w3agile_special_deals_grid_left_grid1">
										<img src="{{asset('/')}}/front-end/images/t3.png" alt=" " class="img-responsive" />
										<p>Quis autem vel eum iure reprehenderit qui in ea voluptate 
											velit esse quam nihil molestiae consequatur, vel illum qui dolorem 
											eum fugiat quo voluptas nulla pariatur</p>
										<h4>Rosy</h4>
				...
				<div class="col-md-5 w3agile_special_deals_grid_right">
					<img src="{{asset('/')}}/front-end/images/20.jpg" alt=" " class="img-responsive" />
		...
		<div class="container">
			...
			<div class="agileinfo_new_products_grids">
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						<div class="hs-wrapper hs-wrapper1">
							<img src="{{asset('/')}}/front-end/images/25.jpg" alt=" " class="img-responsive" />
							<img src="{{asset('/')}}/front-end/images/23.jpg" alt=" " class="img-responsive" />
							<img src="{{asset('/')}}/front-end/images/24.jpg" alt=" " class="img-responsive" />
							<img src="{{asset('/')}}/front-end/images/22.jpg" alt=" " class="img-responsive" />
							<img src="{{asset('/')}}/front-end/images/26.jpg" alt=" " class="img-responsive" /> 
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						<div class="hs-wrapper hs-wrapper1">
							<img src="{{asset('/')}}/front-end/images/27.jpg" alt=" " class="img-responsive" />
							<img src="{{asset('/')}}/front-end/images/28.jpg" alt=" " class="img-responsive" />
							<img src="{{asset('/')}}/front-end/images/29.jpg" alt=" " class="img-responsive" />
							<img src="{{asset('/')}}/front-end/images/30.jpg" alt=" " class="img-responsive" />
							<img src="{{asset('/')}}/front-end/images/31.jpg" alt=" " class="img-responsive" /> 
							<div class="w3_hs_bottom w3_hs_bottom_sub">
								<ul>
									<li>
										<a href="#" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						<div class="hs-wrapper hs-wrapper1">
							<img src="{{asset('/')}}/front-end/images/34.jpg" alt=" " class="img-responsive" />
							<img src="{{asset('/')}}/front-end/images/33.jpg" alt=" " class="img-responsive" />
							<img src="{{asset('/')}}/front-end/images/32.jpg" alt=" " class="img-responsive" />
							<img src="{{asset('/')}}/front-end/images/35.jpg" alt=" " class="img-responsive" />
							<img src="{{asset('/')}}/front-end/images/36.jpg" alt=" " class="img-responsive" /> 
							<div class="w3_hs_bottom w3_hs_bottom_sub">
								<ul>
									<li>
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						<div class="hs-wrapper hs-wrapper1">
							<img src="{{asset('/')}}/front-end/images/37.jpg" alt=" " class="img-responsive" />
							<img src="{{asset('/')}}/front-end/images/38.jpg" alt=" " class="img-responsive" />
							<img src="{{asset('/')}}/front-end/images/39.jpg" alt=" " class="img-responsive" />
							<img src="{{asset('/')}}/front-end/images/40.jpg" alt=" " class="img-responsive" />
							<img src="{{asset('/')}}/front-end/images/41.jpg" alt=" " class="img-responsive" /> 
							<div class="w3_hs_bottom w3_hs_bottom_sub">
								<ul>
									<li>
	...
	<div class="top-brands">
		<div class="container">
			...
			<div class="sliderfig">
				<ul id="flexiselDemo1">			
					<li>
						<img src="{{asset('/')}}/front-end/images/tb1.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="{{asset('/')}}/front-end/images/tb2.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="{{asset('/')}}/front-end/images/tb3.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="{{asset('/')}}/front-end/images/tb4.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="{{asset('/')}}/front-end/images/tb5.jpg" alt=" " class="img-responsive" />
					</li>
				</ul>
			</div>
